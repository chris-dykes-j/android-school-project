...
public class EventOpener extends SQLiteOpenHelper {
    ...
    static final String DATABASE_NAME = "Ticketmaster Events";
    ...
    static final String COL_TYPE = "Type"; // Favourites, Cart, or Both?
    ...
    private final String QUERY = String.format(
            "CREATE TABLE %s (_id INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT,  %s TEXT,  %s TEXT,  %s TEXT,  %s TEXT,  %s TEXT,  %s TEXT,  %s TEXT)",
            TABLE_NAME, COL_NAME, COL_TYPE, COL_URL, COL_IMG_URL, COL_DATE, COL_STATUS, COL_LOCATION, COL_CATEGORY);
